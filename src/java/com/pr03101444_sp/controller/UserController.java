package com.pr03101444_sp.controller;

import com.pr03101444_sp.dao.Arayis_Dao;
import com.pr03101444_sp.dao.Hesabat_Dao;
import com.pr03101444_sp.dao.Main_Dao;
import com.pr03101444_sp.dao.Yekun_Dao;
import com.pr03101444_sp.impl.Arayis;
import com.pr03101444_sp.impl.Hesabat;
import com.pr03101444_sp.impl.Main;
import com.pr03101444_sp.impl.Yekun;
...
public class UserController {
    ...
    public String forLogin(Model model, @RequestParam(value = "key", required = false) String key, @RequestParam(value = "messages", required = false) String messages, String url, Katalog kat) {
        if (key == null) {
            return "redirect:http://localhost:8080/loginControl/?param=pr03101444_sp";
        } else {
