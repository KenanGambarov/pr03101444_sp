package com.pr03101444_sp.object;


public class Arayis_pojo {
    ...
    public String getMues_ad() {
        return mues_ad;
    }

    public void setMues_ad(String mues_ad) {
        this.mues_ad = mues_ad;
    }
